...
namespace DBProject
{
	public partial class ManageService : System.Web.UI.Page
	{
		...
		protected void LoadGrid(string SearchQuery , string Category)
		{
            ...
            {
                objmyDaL.LoadService(ref table, SearchQuery);
		...
		protected void DeleteDoctor_Click(Object sender, GridViewDeleteEventArgs e)
		{
            ...
            else if (Service.Checked == true)
            {
                ...
                if (objDAL.DeleteService(Convert.ToInt32(id)) == 1)
                {
                    Msg.Text = " Service No: " + id + " Deleted";
                    LoadGrid("", "SERVICE");
                }
                else
                {
		...
		protected void Search_btn(object sender, EventArgs e)
		{
			...
			else
			{
				...
				LoadGrid(txtSearch.Text , "SERVICE");
		...
		protected void SelectCommand(object sender, GridViewCommandEventArgs e)
		{
            ...
            else if (Service.Checked == true)
            {
                ...
                if (objDAL.GETSERVICE(id, ref name, ref phone, ref address) == 1)
                {
