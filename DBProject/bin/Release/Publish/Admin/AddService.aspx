<%@ Page Language="C#" AutoEventWireup="true" UnobtrusiveValidationMode="None" CodeBehind="AddService.aspx.cs" Inherits="DBProject.AddService" %>
                                ...
                                <div class="form-box" id="spaces">
                                    <div class="form-top">
                                        <div class="form-top-left">
                                            <h3 style="font-family:Algerian">Service Registration Form
                                 ...
                                 <!--   <div class="form-group">
                                    ...
                                    <asp:Button Text="Add" runat="server" type="submit" class="btn btn-primary" OnClick="ServiceRegister"></asp:Button>
                                    <!-- onclick="signup" -->
