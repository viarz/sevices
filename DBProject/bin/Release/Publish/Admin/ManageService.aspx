<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Service.Master" AutoEventWireup="true" CodeBehind="ManageService.aspx.cs" Inherits="DBProject.ManageService" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <h4 style="font:bold">Virsraksts :</h4>
        <br />

           <asp:RadioButton name="Gender"  OnCheckedChanged="RadioButton_CheckedChanged"
             AutoPostBack="true" id="Service" GroupName="Catagory" runat="server" Text="Service" checked="true" value ="O" />

           <asp:RadioButton name="Gender" OnCheckedChanged="RadioButton_CheckedChanged"
             AutoPostBack="true" id="Doctor" GroupName="Catagory" runat="server" Text="Doctor"  value ="D" />
